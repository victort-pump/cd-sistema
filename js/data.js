...
const EQUIPE_DEFAULT = [
  ...
  { id: 'isa',     nome: 'Isa Caruso',    funcao: 'Copy',                    clientes: ['AI','TM','AS','MP','WG','PL','DL','MN'] },
  { id: 'fernanda',nome: 'Fernanda Naya', funcao: 'Design',                  clientes: ['AI','AS','MP'] },
  { id: 'ana',     nome: 'Ana',           funcao: 'Design',                  clientes: ['DL','MN'] },
  { id: 'luis',    nome: 'Luís Lobão',    funcao: 'Edição de Vídeo',         clientes: ['AI','TM','WG','PL'] },
  { id: 'yasmin',  nome: 'Yasmin',        funcao: 'Edição de Vídeo',         clientes: ['AS','MP','DL','MN'] },
  ...
  { id: 'pedro',   nome: 'Pedro Victor',  funcao: 'Design',                  clientes: ['TM','WG'] },
  { id: 'maruju',  nome: 'Ana Maruju',    funcao: 'Design',                  clientes: ['PL'] }
];

const ALOCACAO = {
  AI: { pai: 'isa', copy: 'isa',                    revisao: 'cd', design: 'fernanda', edicao: 'luis',   trafego: ['dai','thais'] },
  AS: { pai: 'cd', copy: 'isa', assistCopy: 'isa', revisao: 'cd', design: 'fernanda', edicao: 'yasmin', trafego: ['dai','thais'] },
...
const FLUXO_SEMANAL = {
  PL: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 3, tarefas: [
      { tipo: 'copy',   subtipo: 'feed1',     respKey: 'copy',   offset: -2 },
      { tipo: 'design', subtipo: 'feed1',     respKey: 'design', offset: -1 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 5, tarefas: [
      { tipo: 'copy',   subtipo: 'feed2',     respKey: 'copy',   offset: -4 },
      { tipo: 'design', subtipo: 'feed2',     respKey: 'design', offset: -3 }
    ]},
    { nome: 'Vídeo', key: 'video', postDow: 2, tarefas: [
      { tipo: 'copy',   subtipo: 'copy-capa', respKey: 'copy',   offset: -1 },
      { tipo: 'copy',   subtipo: 'legenda',   respKey: 'copy',   offset: -1 },
      { tipo: 'video',  subtipo: 'reels',     respKey: 'edicao', offset: -1 },
      { tipo: 'design', subtipo: 'capa-video',respKey: 'design', offset: -1 }
    ]}
  ]},
  AI: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 2, tarefas: [
      { tipo: 'copy',   subtipo: 'feed1', respKey: 'copy',   offset: -4 },
      { tipo: 'design', subtipo: 'feed1', respKey: 'design', offset:  0 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 5, tarefas: [
    ...
    { nome: 'Vídeo', key: 'video', postDow: 3, tarefas: [
      { tipo: 'copy',   subtipo: 'copy-capa', respKey: 'copy',   offset: -5 },
      { tipo: 'copy',   subtipo: 'legenda',   respKey: 'copy',   offset: -5 },
      { tipo: 'video',  subtipo: 'reels',     respKey: 'edicao', offset:  0 },
      { tipo: 'design', subtipo: 'capa-video',respKey: 'design', offset:  0 }
    ]}
  ]},
  AS: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 3, tarefas: [
      { tipo: 'copy',    subtipo: 'feed1', respKey: 'copy',   offset: -2 },
      { tipo: 'revisao', subtipo: 'feed1', respKey: 'revisao',offset: -1 },
      { tipo: 'design',  subtipo: 'feed1', respKey: 'design', offset:  0 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 4, tarefas: [
      { tipo: 'copy',    subtipo: 'feed2', respKey: 'copy',   offset: -3 },
      { tipo: 'revisao', subtipo: 'feed2', respKey: 'revisao',offset: -2 },
      { tipo: 'design',  subtipo: 'feed2', respKey: 'design', offset: -1 }
    ]},
    { nome: 'Vídeo', key: 'video', postDow: 5, tarefas: [
      { tipo: 'copy',   subtipo: 'copy-capa', respKey: 'copy',   offset: -4 },
      { tipo: 'copy',   subtipo: 'legenda',   respKey: 'copy',   offset: -4 },
      { tipo: 'video',  subtipo: 'reels',     respKey: 'edicao', offset:  0 },
      { tipo: 'design', subtipo: 'capa-video',respKey: 'design', offset:  0 }
    ]}
  ]},
  MP: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 5, tarefas: [
      ...
      { tipo: 'design',  subtipo: 'feed1', respKey: 'design', offset: -4 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 4, tarefas: [
      { tipo: 'copy',   subtipo: 'feed2', respKey: 'copy',   offset: -7 },
      { tipo: 'design', subtipo: 'feed2', respKey: 'design', offset: -3 }
    ...
    { nome: 'Dark Post', key: 'dark', postDow: 4, tarefas: [
      ...
      { tipo: 'dark', subtipo: 'design-dark', respKey: 'designDark', offset: -3 }
    ]},
  ...
  TM: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 1, tarefas: [
      { tipo: 'copy',    subtipo: 'feed1', respKey: 'copy',   offset: -4 },
      { tipo: 'revisao', subtipo: 'feed1', respKey: 'revisao',offset: -3 },
      { tipo: 'design',  subtipo: 'feed1', respKey: 'design', offset:  0 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 3, tarefas: [
      { tipo: 'copy',    subtipo: 'feed2', respKey: 'copy',   offset: -6 },
      { tipo: 'revisao', subtipo: 'feed2', respKey: 'revisao',offset: -5 },
      { tipo: 'design',  subtipo: 'feed2', respKey: 'design', offset:  0 }
    ]},
    { nome: 'Vídeo', key: 'video', postDow: 2, tarefas: [
      { tipo: 'copy',   subtipo: 'copy-capa', respKey: 'copy',   offset: -5 },
      { tipo: 'copy',   subtipo: 'legenda',   respKey: 'copy',   offset: -5 },
  ...
  WG: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 1, tarefas: [
      { tipo: 'copy',    subtipo: 'feed1', respKey: 'copy',   offset: -5 },
      { tipo: 'revisao', subtipo: 'feed1', respKey: 'revisao',offset: -4 },
      { tipo: 'design',  subtipo: 'feed1', respKey: 'design', offset:  0 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 5, tarefas: [
      { tipo: 'copy',    subtipo: 'feed2', respKey: 'copy',   offset: -9 },
      { tipo: 'revisao', subtipo: 'feed2', respKey: 'revisao',offset: -8 },
      { tipo: 'design',  subtipo: 'feed2', respKey: 'design', offset: -4 }
    ]},
    { nome: 'Vídeo', key: 'video', postDow: 2, tarefas: [
      { tipo: 'copy',   subtipo: 'copy-capa', respKey: 'copy',   offset: -6 },
      { tipo: 'copy',   subtipo: 'legenda',   respKey: 'copy',   offset: -6 },
      { tipo: 'video',  subtipo: 'reels',     respKey: 'edicao', offset:  0 },
      { tipo: 'design', subtipo: 'capa-video',respKey: 'design', offset:  0 }
    ]}
  ]},
  DL: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 1, tarefas: [
      { tipo: 'copy',   subtipo: 'feed1',     respKey: 'copy',   offset: -5 },
      { tipo: 'design', subtipo: 'feed1',     respKey: 'design', offset: -3 }
    ]},
  ...
  MN: { pieces: [
    { nome: 'Design 1', key: 'feed1', postDow: 1, tarefas: [
      { tipo: 'copy',   subtipo: 'feed1',     respKey: 'copy',   offset: -3 },
      { tipo: 'design', subtipo: 'feed1',     respKey: 'design', offset:  0 }
    ]},
    { nome: 'Design 2', key: 'feed2', postDow: 5, tarefas: [
      { tipo: 'copy',   subtipo: 'feed2',     respKey: 'copy',   offset: -7 },
...
// Sexta: 17h é fechamento, NÃO é produção
const SEMANA_IDEAL = {
  'Segunda': [
  ...
  'Sexta': [
    ...
    { time:'17:00–18:00', label:'Fechamento de semana',  detalhe:'Encerramento — NÃO é bloco de produção', tipo:'bloqueado' }
  ]
};
